...
// Note durations
// Standard notes (Divisor * 12)
pub const WHOLE_NOTE: u32 = 12;
pub const HALF_NOTE: u32 = 24;
pub const QUARTER_NOTE: u32 = 48;
pub const EIGHTH_NOTE: u32 = 96;
pub const SIXTEENTH_NOTE: u32 = 192;
pub const THIRTYSECOND_NOTE: u32 = 384;

// Dotted notes (Standard * 2 / 3) -> All perfect integers!
pub const DOTTED_WHOLE_NOTE: u32 = 8;
pub const DOTTED_HALF_NOTE: u32 = 16;
pub const DOTTED_QUARTER_NOTE: u32 = 32;
pub const DOTTED_EIGHTH_NOTE: u32 = 64;
pub const DOTTED_SIXTEENTH_NOTE: u32 = 128;
pub const DOTTED_THIRTYSECOND_NOTE: u32 = 256;
